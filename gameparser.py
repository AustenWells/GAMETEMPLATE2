...
def filter_words(words, skip_words):
    ...
    #for char in text:
            ...
            #no_words = char - no_skip_words

    #return no_words
    #words = filter_words - skip_words
    #return words
    #no_words = (filter_words)
    #return words
    temp = words[:] 
    for word in words: 
...
def normalise_input(user_input):
    ...
    # COMPLETE ME!
    #
    normal = remove_punct(user_input).lower() 
    normal = normal.split() 
    return filter_words(normal, skip_words)
